    ...
    <section id="oportunidades" className={`py-24 bg-surface-container-low ${className}`}>
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="mt-20 text-center">
          <a href="/catalogo" className="group inline-flex items-center gap-3 text-secondary font-bold text-sm tracking-widest uppercase hover:gap-5 transition-all">
            VER TODOS LOS LISTADOS URBANOS
