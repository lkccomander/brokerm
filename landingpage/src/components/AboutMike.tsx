      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-col md:flex-row gap-20 items-center">
          ...
          <div className="w-full md:w-1/2">
            <span className="text-secondary font-bold text-xs tracking-[0.3em] uppercase mb-6 block">EL GUIA ESTRATEGICO</span>
            <h2 className="font-headline text-5xl font-extrabold text-on-surface leading-tight mb-8">El Guia Estrategico Detras de su Inversion Urbana</h2>
            <p className="text-tertiary text-lg leading-relaxed mb-6">
              Con mas de dos decadas en el corazon del mercado inmobiliario premium, Mike no solo vende propiedades; disena carteras de inversion que perduran. Su enfoque combina la precision del analisis de datos con una red de contactos inigualable en el Gran Area Metropolitana.
            </p>
            <div className="grid grid-cols-2 gap-8 mb-10">
              <div>
                <div className="text-3xl font-extrabold text-on-surface">{aboutMike.yearsExperience}</div>
                <div className="text-xs font-medium text-tertiary">ANOS DE EXPERIENCIA</div>
              </div>
              <div>
                <div className="text-3xl font-extrabold text-on-surface">{aboutMike.clientsTotal}</div>
                <div className="text-xs font-medium text-tertiary">CLIENTES SATISFECHOS</div>
              </div>
            </div>
            <a href="/#contacto" className="cta-gradient inline-flex text-on-primary px-10 py-4 rounded-xl font-bold shadow-xl shadow-primary/30 hover:-translate-y-1 transition-transform">
              Conoce a Mike
            </a>
          </div>
        </div>
