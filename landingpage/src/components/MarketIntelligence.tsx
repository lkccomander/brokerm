      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div className="max-w-xl">
            <h2 className="font-headline text-4xl font-extrabold text-on-surface mb-4">Inteligencia de Mercado</h2>
            <p className="text-tertiary text-lg leading-relaxed">Analizamos miles de puntos de datos para ofrecerle una vision clara del panorama inmobiliario metropolitano.</p>
          </div>
          <div className="flex gap-2 text-secondary font-bold text-sm tracking-widest items-center">
            ACTUALIZADO: HOY <span className="w-2 h-2 rounded-full bg-secondary animate-pulse"></span>
          </div>
        </div>
